...
/**
 * The headline figures of a degreeProgram's освітня програма, and every statutory rule the plan
 * currently breaks.
 *
 * Purely presentational: it renders a {@link CurriculumPlan} and computes nothing, so both
 * degreeProgram tabs that show a curriculum — the flat table ("Навчальні плани") and the course-first
